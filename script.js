...
const events = [
    ...
    { title: '우리가 사랑을 쓰던 날', actor: '전하영', start: '2026-07-25', time: '17:40', color: '#5E9EA0', memo: '광명시민회관 공연장' },
    ...
    // ===== 오유민 =====
    // 까라마조프의 자매들
    { title: '까라마조프의 자매들', actor: '오유민', start: '2026-09-09', time: '20:00', color: '#3B6FB6', memo: '' },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 한국 공휴일 (대체공휴일 포함) — 음력 명절은 해마다 달라서 하드코딩, 해 바뀌면 여기에 추가
    const HOLIDAYS = {
        '2025-06-03': '선거일', '2025-06-06': '현충일', '2025-08-15': '광복절',
        '2025-10-03': '개천절', '2025-10-05': '추석', '2025-10-06': '추석',
        '2025-10-07': '추석', '2025-10-08': '대체휴일', '2025-10-09': '한글날',
        '2025-12-25': '성탄절',
        '2026-01-01': '신정', '2026-02-16': '설날', '2026-02-17': '설날', '2026-02-18': '설날',
        '2026-03-01': '삼일절', '2026-03-02': '대체휴일',
        '2026-05-05': '어린이날', '2026-05-24': '부처님오신날', '2026-05-25': '대체휴일',
        '2026-06-03': '선거일', '2026-06-06': '현충일', '2026-07-17': '제헌절',
        '2026-08-15': '광복절', '2026-08-17': '대체휴일',
        '2026-09-24': '추석', '2026-09-25': '추석', '2026-09-26': '추석',
        '2026-10-03': '개천절', '2026-10-05': '대체휴일', '2026-10-09': '한글날',
        '2026-12-25': '성탄절',
        '2027-01-01': '신정', '2027-02-06': '설날', '2027-02-07': '설날',
        '2027-02-08': '설날', '2027-02-09': '대체휴일',
        '2027-03-01': '삼일절', '2027-05-05': '어린이날', '2027-05-13': '부처님오신날',
        '2027-06-06': '현충일', '2027-07-17': '제헌절', '2027-07-19': '대체휴일',
